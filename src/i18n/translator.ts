...
/**
 * Build a translator from an already-resolved dictionary. Pure — imports no
 * locale data, so client bundles only ship the active locale passed in as props.
 */
export function makeTranslator(locale: Locale, messages: Messages) {
